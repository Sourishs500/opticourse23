...
# filename = 'Linguistics_and_Computer_Science_B.A._DegreeRequirements.txt'
# filename = 'Electrical_Engineering_B.S._DegreeRequirements.txt'
filename = 'Computer_Engineering_B.S._DegreeRequirements.txt'
# filename = 'Mechanical_Engineering_B.S._DegreeRequirements.txt'
# filename = 'Middle_Eastern_Studies_B.A._DegreeRequirements.txt'
# filename = 'Civil_Engineering_B.S._DegreeRequirements.txt'
# filename = 'Computer_Science_and_Engineering_B.S._DegreeRequirements.txt'
